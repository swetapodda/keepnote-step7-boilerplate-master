## Seed code - Boilerplate for step 7 CategoryService - KeepNote Assignment

### Problem Statement

In this case study KeepNote Step 7 - CategoryService, We will write main class for spring boot Application, model class, repository class, service class and interface, logging aspect.
