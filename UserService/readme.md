## Seed code - Boilerplate for step 7 UserService - KeepNote Assignment

### Problem Statement

In this case study KeepNote Step 7 - UserService, We will write main class for spring boot Application, model class, repository class, service class and interface, logging aspect.
